...
st.set_page_config(page_title="Leaf Size 5006 Ensemble 1005", page_icon="🍂🍂")
...
with st.form("parameters_form"):
    ...
    images = st.file_uploader(label="Input Folder of Images", type=None, accept_multiple_files=True,
                           key=None, help=None,
